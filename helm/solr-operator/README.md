...
Before upgrading your Solr Operator to a newer version, **please refer to the [Upgrade Notes](https://solr.apache.org/guide/operator/0_6/upgrade-notes/upgrade-notes.html)**.
