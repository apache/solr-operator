...
Before upgrading your Solr Operator to a newer version, **please refer to the [Upgrade Notes](https://solr.apache.org/guide/operator/0_7/upgrade-notes/upgrade-notes.html)**.
...
```bash
kubectl replace -f https://solr.apache.org/operator/downloads/crds/v0.7.2-prerelease/all-with-dependencies.yaml
helm upgrade solr-operator apache-solr/solr-operator --version 0.7.2-prerelease
```
...
| image.tag | string | `"v0.7.2-prerelease"` | The tag/version of the Solr Operator to run |
