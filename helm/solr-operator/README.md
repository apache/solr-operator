...
```bash
kubectl create -f https://solr.apache.org/operator/downloads/crds/v0.9.1-prerelease/all-with-dependencies.yaml
...
```bash
kubectl replace -f https://solr.apache.org/operator/downloads/crds/v0.9.1-prerelease/all-with-dependencies.yaml
...
| image.tag | string | `"v0.9.1-prerelease"` | The tag/version of the Solr Operator to run |
