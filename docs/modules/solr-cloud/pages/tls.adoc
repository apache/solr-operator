...
If you already have a TLS certificate you want to use for Solr, then you don't need cert-manager and can skip down to <<already-have-a-tls-certificate,I already have a TLS Certificate>> later in this section.
...
[#already-have-a-tls-certificate]
