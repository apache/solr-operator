...
* xref:solr-cloud:solr-cloud-crd.adoc[All SolrCloud CRD Options] - Please refer here when trying to find new SolrCloud options/features.
* xref:solr-cloud:managed-updates.adoc[Managed Updates]
* xref:solr-cloud:scaling.adoc[Scaling]
...
For more information on SolrCloud scaling, refer to the xref:solr-cloud:scaling.adoc[scaling page].
...
The Solr Operator is only guaranteed to work with https://hub.docker.com/_/solr[official Solr images].
...
Please refer to the xref:upgrade-notes:upgrade-notes.adoc#solr-versions[Version Compatibility Matrix] for more information on what Solr Versions are compatible with the Solr Operator.
