...
If you want to skip versions when upgrading, be sure to check out the <<upgrading-minor-versions-vxa-vxb>> and <<upgrading-patch-versions-vxya-vzyb>> sections.
...
However, no matter the upgrade, always read the <<upgrade-warnings-and-notes>> for every version between
...
Be sure to carefully read the <<upgrade-warnings-and-notes>> to be sure you are not using deprecated options.
