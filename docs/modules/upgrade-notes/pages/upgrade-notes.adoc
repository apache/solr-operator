...
| `v0.2.6` | YES | YES | YES | NO
| `v0.2.7` | NO | YES | YES | NO
| `v0.2.8` | NO | YES | YES | NO
| `v0.3.x` | NO | YES | YES | NO
| `v0.4.x` | NO | YES | YES | NO
| `v0.5.x` | NO | NO | YES | YES
| `v0.6.x` | NO | NO | YES | YES
|===
...
+
WARNING: This means that Kubernetes support is now limited to 1.19+.
...
+
WARNING: This means that Kubernetes support is now limited to 1.16+.
