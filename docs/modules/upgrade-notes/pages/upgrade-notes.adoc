...
+
Users using the S3 persistence option should try to use the xref:solr-backup:index.adoc#s3-backup-repositories[S3 backup repository] instead. This requires Solr 8.10 or higher.
