...
* <<setup,Setup>>
** <<setup-docker-for-mac-with-k8s-with-an-ingress-controller,Setup Docker for Mac with K8S with an Ingress Controller>>
...
** <<building-the-solr-operator,Building the Solr Operator>>
