= Releasing a New Version of the Solr Operator
...
* <<release-wizard,Use the Release Wizard>>

== Versioning

The Solr Operator follows kubernetes conventions with versioning which is:
...
Certain systems except versions that do not start with `v`, such as Helm.
