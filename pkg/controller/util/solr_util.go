...
func GenerateStatefulSet(solrCloud *solr.SolrCloud, newStatus *solr.SolrCloudStatus, ingressBaseDomain string, hostNameIPs map[string]string) *appsv1.StatefulSet {
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "ZK_HOST",
									Value: newStatus.ZkConnectionString(),
								},
								{
									Name:  "SOLR_LOG_LEVEL",
