...
import (
	...
	solr "github.com/bloomberg/solr-operator/pkg/client/informers/externalversions/solr"
...
func (f *sharedInformerFactory) Solr() solr.Interface {
	return solr.New(f, f.namespace, f.tweakListOptions)
}
