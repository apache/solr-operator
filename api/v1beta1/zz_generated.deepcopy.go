...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedStorage) DeepCopyInto(out *ManagedStorage) {
	*out = *in
	if in.Volume != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedStorage.
func (in *ManagedStorage) DeepCopy() *ManagedStorage {
	if in == nil {
		return nil
	}
	out := new(ManagedStorage)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SolrBackupRestoreOptions) DeepCopyInto(out *SolrBackupRestoreOptions) {
	*out = *in
	...
	if in.GcsRepositories != nil {
		in, out := &in.GcsRepositories, &out.GcsRepositories
		*out = new([]GcsStorage)
		if **in != nil {
			in, out := *in, *out
			*out = make([]GcsStorage, len(*in))
			copy(*out, *in)
		}
	}
	if in.ManagedRepositories != nil {
		...
		*out = new([]ManagedStorage)
		if **in != nil {
			in, out := *in, *out
			*out = make([]ManagedStorage, len(*in))
			for i := range *in {
				(*in)[i].DeepCopyInto(&(*out)[i])
			}
		}
