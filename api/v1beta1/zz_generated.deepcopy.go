...
func (in *CustomSolrKubeOptions) DeepCopyInto(out *CustomSolrKubeOptions) {
	*out = *in
	...
	if in.HTTPRouteOptions != nil {
		in, out := &in.HTTPRouteOptions, &out.HTTPRouteOptions
		*out = make([]HTTPRouteOptions, len(*in))
		for i := range *in {
...
func (in *HTTPRouteOptions) DeepCopyInto(out *HTTPRouteOptions) {
	*out = *in
	...
	if in.ParentRefs != nil {
		...
		*out = make([]HTTPRouteParentReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPRouteParentReference) DeepCopyInto(out *HTTPRouteParentReference) {
	*out = *in
	if in.Group != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRouteParentReference.
func (in *HTTPRouteParentReference) DeepCopy() *HTTPRouteParentReference {
	if in == nil {
		return nil
	}
	out := new(HTTPRouteParentReference)
	in.DeepCopyInto(out)
	return out
}
