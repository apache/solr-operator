...
- [Local Tutorial](https://solr.apache.org/guide/operator/0_5/getting-started/local-tutorial.html)
...
- [Running the Solr Operator](https://solr.apache.org/guide/operator/0_5/getting-started/running-the-operator.html)
- Available Solr Resources
    - [Solr Clouds](https://solr.apache.org/guide/operator/0_5/solr-cloud/index.html)
    - [Solr Backups](https://solr.apache.org/guide/operator/0_5/solr-backup/index.html)
    - [Solr Metrics](https://solr.apache.org/guide/operator/0_5/solr-prometheus-exporter/index.html)
- [Development](https://solr.apache.org/guide/operator/0_5/development/development.html)
...
Make sure to check the [Solr Operator Upgrade notes](https://solr.apache.org/guide/operator/0_5/upgrade-notes/upgrade-notes.html), before upgrading the Solr Operator or CRDs in your Kubernetes cluster.

This page also contains [Version Compatibility Matrixes](https://solr.apache.org/guide/operator/0_5/upgrade-notes/upgrade-notes.html#version-compatibility-matrixes), which detail the compatible Solr versions and Kubernetes versions for each release of the Solr Operator.
